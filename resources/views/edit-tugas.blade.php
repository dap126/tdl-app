    ...
    <div class="row mt-4">
        <div class="col-lg-8 mx-auto">
            <div class="card mb-4 shadow-sm">
                <div class="card-header"><h3 class="card-title">Edit Tugas</h3></div>
                <div class="card-body">
                    <form action="{{ route('tugas.update', $tugas->tugas_id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('daftar_id') is-invalid @enderror" id="daftar_id" name="daftar_id" required>
                                ...
                                @foreach ($daftarTugas as $daftar)
                                    <option value="{{ $daftar->daftar_id }}" {{ old('daftar_id', $tugas->daftar_id) == $daftar->daftar_id ? 'selected' : '' }}>
                                        {{ $daftar->nama_daftar }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nama_matakuliah') is-invalid @enderror" id="nama_matakuliah" name="nama_matakuliah" value="{{ old('nama_matakuliah', $tugas->mataKuliah->nama_matakuliah ?? '') }}" placeholder="Ketik nama mata kuliah jika ada">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="datetime-local" class="form-control @error('tanggal_deadline') is-invalid @enderror" id="tanggal_deadline" name="tanggal_deadline" value="{{ old('tanggal_deadline', $tugas->tanggal_deadline ? date('Y-m-d\TH:i', strtotime($tugas->tanggal_deadline)) : '') }}">
                        ...
                        <div class="d-flex justify-content-end">
                            <a href="{{ route('list-tugas') }}" class="btn btn-secondary me-2">Batal</a>
