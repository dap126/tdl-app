          ...
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item dropdown user-menu">
              <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                <img
                  src="https://ui-avatars.com/api/?name={{ urlencode(Auth::user()->fullname) }}&background=0D6EFD&color=fff&size=128"
                  class="user-image rounded-circle shadow"
                  alt="User Image"
                />
                <span class="d-none d-md-inline">Halo, {{ Auth::check() ? Auth::user()->username : 'Guest'}}</span>
              </a>
              <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                ...
                <li class="user-header text-bg-secondary">
                  ...
                  <p>
                    ...
                    <small>Member since {{ Auth::check() ? Auth::user()->created_at->format('F Y') : 'Guest'}}</small>
                  </p>
                </li>
                <!--end::User Image-->
